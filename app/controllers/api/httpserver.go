...
func RegisterHTTP(rs *httpserver.Registry, runMode string) {
	...
	rs.Register("ApiAuth", "Login", []httpserver.BeforeFunc{before}, s.Login)
	rs.Register("ApiAuth", "Logout", []httpserver.BeforeFunc{before}, s.Logout)
	rs.Register("ApiAuth", "Register", []httpserver.BeforeFunc{before}, s.Register)
}
