...
| content | `09-08-application-content/acceptance/evidence-matrix.md` E-C04/E-C23/E-C28～E-C30 | paired data/quarantine roots 的 same-filesystem/non-public/startup fail-closed、durable quarantine 跨主机恢复；Linux/container PDF local-file deny、零 outbound、恶意 HTML 负向 artifact 与 cleanup 绑定同一 candidate | `blocked` |
